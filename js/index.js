...
const PointsHeight = document.querySelector('.points').getBoundingClientRect().height;
...
PrecauImages.forEach(ele => {
  ...
  img.classList.remove( `${Number.parseInt(num)%2 == 0 ? 'anime__right' : 'anime__left'}` );
});
